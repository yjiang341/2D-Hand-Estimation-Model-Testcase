...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Offline FSK sender: packet stream -> WAV modulation"
    )
    ...
    parser.add_argument("--out-wav", type=str, default="logs/fsk_sender.wav")
    parser.add_argument("--out-packets", type=str, default="logs/pose_packets.bin")
