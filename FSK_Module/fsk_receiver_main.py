...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Phase 2.2 offline FSK receiver: WAV -> packet stream"
    )
    parser.add_argument("--in-wav", type=str, default="logs/phase2_1_sender.wav")
    ...
    parser.add_argument("--out-recovered", type=str, default="logs/phase2_2_recovered_packets.bin")
...
def main() -> None:
    ...
    print("=== Phase 2.2 FSK Receiver Output ===")
