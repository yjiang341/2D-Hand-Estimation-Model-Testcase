...
from Estimation_Module.FSK_Module.fsk_modem import FSKConfig, bytes_to_bits, modulate_bits_fsk
from Estimation_Module.Pose_PacketUp.pose_packet import PACKET_SIZE, PacketDecodeError, PosePacket, decode_packet
    ...
    for preamble_start in preamble_positions:
        ...
        try:
            ...
            for hand in decoded.hands:
                ...
                xy = quantized_hand_to_xy_pairs(hand)

                print(
                    f"frame={decoded.frame_id}",
                    f"points={len(xy)}"
                )
